...
class TyxoPage {
    ...
    function html() {
        ...
        if(empty(TYXO_STATUSPAGE_BIG_ID)) {

            $html   = '<div class="panel">
                <div class="panel-body">
                    <div>Status Page is not configured yet.</div>
            ...
            jQuery( document ).ready(function() {
               ...
               var params       = {};
               params.big_id    = "'.TYXO_STATUSPAGE_BIG_ID.'";
               tx_jsonp("statuspage/overview.do", params,  process, loader_animation_base, 180);
