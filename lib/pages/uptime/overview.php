...
class TyxoPage {
	...
	function html() {
	    ...
	    if(empty(TYXO_WEBCHECK_BIG_ID)) {

            $html   = '<div class="panel">
                <div class="panel-body">
                    <div>Uptime check is not configured yet.</div>
            ...
            jQuery( document ).ready(function() {
               ...
               var params       = {};
               params.big_id    = "'.TYXO_WEBCHECK_BIG_ID.'";
               tx_jsonp("uptime/overview.do", params,  process, loader_animation_base, 180);
